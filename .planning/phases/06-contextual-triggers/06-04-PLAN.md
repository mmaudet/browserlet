...
must_haves:
  ...
  key_links:
    ...
    - from: "entrypoints/background/messaging.ts GET_TRIGGERS handler"
      to: "initializeTriggerEngine"
      via: "await initialization before returning triggers"
      pattern: "await initializeTriggerEngine.*getAllTriggers"
---
